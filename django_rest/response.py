...
class JsonResponse(HttpResponseBase):
    def __init__(self, content=None, status_code=200, **kwargs):
        super(JsonResponse, self).__init__(content_type="application/json", status_code, **kwargs)
...
#        self.reason_phrase = reason or responses.get(status_code, "Unknown Status Code")
